    ...
    async function register() {
        ...
        const payload = {
            registrant_detail: {
                ...
                addr_villa_number: data.addr_villa_number ? `Villa ` + data.addr_villa_number : null,
                addr_villa_lane_no: data.addr_villa_lane_no ? "Lane " + data.addr_villa_lane_no : null,
                addr_villa_phase_no: data.addr_villa_phase_no ? "Phase " + data.addr_villa_phase_no : null,
                addr_tower_no: data.addr_tower_no ? "Phase " + data.addr_tower_no : null,
                addr_tower_block_no: data.addr_tower_block_no ? "Block " + data.addr_tower_block_no : null, 
                addr_tower_flat_no: data.addr_tower_flat_no ? "Flat " + data.addr_tower_flat_no : null,
